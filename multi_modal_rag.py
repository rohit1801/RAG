...
# LangChain for LLMs and vector stores
...
def create_ai_enhanced_summary(text: str, tables: List[str], images: List[str]) -> str:
    ...
    try:
        ...
        llm = ChatOllama(model="qwen2.5vl:7b", temperature=0.7)
...
def create_vector_store(chunks, persist_directory="db2/chroma_db"):
...
def run_complete_ingestion_pipeline(file_path: str = "docs/attention-is-all-you-need.pdf"):
    ...
    # Optionally, chunk by title if needed
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest a PDF into the ChromaDB vector store.")
    parser.add_argument(
        "--file_path",
        "-f",
        type=str,
